...
def execute_luis_query(turn_context: TurnContext) -> (Intent, object):
    """
    ...
    intent = None
    try:
        recognizer_result =  luis_recognizer.recognize(turn_context)
        intent = (
...
if __name__=="__main__":
    A=Intent.BOOK_FLIGHT
    print(A.value)

    execute_luis_query("Travel to Paris")
